...
public class Prefab_ConnectWallet : MonoBehaviour
{
    ...
    public async void OnConnect(Wallet _wallet)
    {
        try
        {
            ...
            if(ThirdwebManager.Instance.chain == Chain.Mumbai){
                wallet = _wallet;
                OnConnected();
                ...
                print($"Error Connecting Wallet: Choose Mumbai");
            }
    ...
    async void OnConnected()
    {
        try
        {
            ...
            menu.GetComponent<Menu>().toggleStartScreen();
        }
        catch (Exception e)
        {
    ...
    void OnDisconnected()
    {
        ...
        menu.GetComponent<Menu>().ForceMenu();
    }
