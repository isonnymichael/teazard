...
public class Menu : MonoBehaviour {
	...
	public async void connectingOnRightChain(){
		...
		if(myChainId == Web3Auth.Instance.chainId)
		{
			...
			Web3Auth.Instance.contractToken = Web3Auth.Instance.sdk.GetContract("0x89a4C0f4F0E4023ef8B8106DDc9f64681FFd57CD",abi);
			...
			Web3Auth.Instance.contractGame = Web3Auth.Instance.sdk.GetContract("0x3C897ee0ED8eBC0310793a1d90A54cDF51e7806B",abiGame);
			
			// Connect ke NFT SMART CONTRACT
			Web3Auth.Instance.contractNFT = Web3Auth.Instance.sdk.GetContract("0xA76bC976f3AbCd9d0f806d58aC82e09D76F14105");
